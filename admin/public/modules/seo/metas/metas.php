...
<div class="page-usuarios page" data-page="14"  data-subpage="1">
	...
	<table class="data-table display nowrap striped highlight" cellspacing="0" width="100%">
	    <thead>
	        <tr>
	            ...
	            <th data-priority="4">Página</th>
	            <th data-priority="5">Identificador</th>
						...
						if(isConfirm){
							...
							.done(function(res) {
								if(res.tipo == 'sucesso'){
									...
									swal("Excluir Meta", res.mensagem, 'success');
								}else{
									swal("Excluir Meta", res.mensagem, 'error');
								}
