	        ...
	        callback: function(key, options) {
		        ...
		        switch (key) {
		        	...
		        	case 'imagem' :
			        	...
			        	ajaxPopup('/admin/public/modules/sistema/arquivo/form.php?tabela=blog&tipo=principal&id=' + id);
			        	break;
			        case 'seo-meta':
			        	ajaxPopup('/admin/public/modules/seo/metas/form.php?pagina=conteudo&identificador=' + id);
			        	break;
			     case 'seo-url':
			        	ajaxPopup('/admin/public/modules/seo/urls/form.php?id='+id+'&urlOrigem=conteudo/' + id);
			        	break;
			        case 'excluir' :
