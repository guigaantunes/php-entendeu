        ...
        <li style="<? if(!$cel){ echo " width:400px; ";} ?>" class="exclusive">
          <ul class="pricing-wrapper">
            ...
            <li data-type="monthly" class="is-visible is-ended">
              ...
              <footer class="pricing-footer"> <a class="select" href="https://entendeudireito.com.br/checkout?vip=0">Assine</a> </footer>
            </li>
            <?
            }
            else if($vip=="1"){
      ...
      <div class="agileinfo_main_bottom_grid">
        <div id="horizontalTab">
          <ul class="resp-tabs-list">
            <li><img src="https://entendeudireito.com.br/application/views/checkout/images/1.jpg" alt=" cartao" /></li>
            <li><img src="https://entendeudireito.com.br/application/views/checkout/images/2.jpg" width="70" height="20" alt="boleto " /></li>
          </ul>
