	...
	<table class="data-table display nowrap striped highlight" cellspacing="0" width="100%">
	    <thead>
	        <tr>
	            ...
	            <th data-priority="5">Meses</th>
	            <th data-priority="6">Valor Básico</th>
	            <th data-priority="7">Valor VIP</th>
	            <th data-priority="8">Ordem</th>
	...
	$(function() {		
	    var table = $('.data-table').DataTable( {
	        ...
	        columns: [
	            ...
	            { data: "titulo", },
	            { data: "meses", },
	            { data: "valor_basico", render:function(data){
    	            return "R$"+data;
	            }},
	            { data: "valor_vip", render:function(data){
    	            return "R$"+data;
	            }},
	            { data: "ordem", },
	            { data: "ativo", render: function(data) {
    	            return data == 1 ? "<span style='color:green'>Ativo</span>" : "<span style='color:red'>Inativo</span>"
	            }},
	            {
		            width: '50px',
	                data: null,
