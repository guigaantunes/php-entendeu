...
<div class="usuario-form">
	...
	<div class="modal-content modal-fixed-footer">
		<form action="<?=$pathModulo?>ajax.php" id="modal" data-update="false" data-datatable="true">
			...
			<input type="hidden" value="<?=$idMateria?>" name="dados[id_materia]"/>
			...
			<div class="row">
				...
				<div class="input-field col s12 m12">
					<input id="ordem" type="number" value="<?=($id ? $registro["ordem"] : $class->nextOrder($idMateria))?>" required name="dados[ordem]">
