    ...
    // event handlers
        handle = {
            ...
            itemClick: function (e) {
                ...
                if (!opt.items[key] || $this.is('.' + root.classNames.disabled + ', .context-menu-submenu, .divider, .' + root.classNames.notSelectable)) {
                    return;
                }
    ...
    // operations
        op = {
            ...
            create: function (opt, root) {
                ...
                // create contextMenu
                opt.$menu = $('<ul class="context-menu-list dropdown-content"></ul>').addClass(opt.className || '').data({
                    'contextMenu': opt,
                ...
                $.each(opt.items, function (key, item) {
                    ...
                    if (item.type && types[item.type]) {
                        ...
                        if (item.type === 'cm_seperator') {
                            $t.addClass('divider ' + root.classNames.notSelectable);
