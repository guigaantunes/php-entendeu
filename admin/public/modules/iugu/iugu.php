	...
	<table class="data-table display nowrap striped highlight" cellspacing="0" width="100%">
	    <thead>
	        <tr>
	            ...
	            <th data-priority="5">Data de Cadastro</th>
...
<script>
	$(function() {		
	    var table = $('.data-table').DataTable( {
	        ...
	        colReorder: true,
	        ajax: "<?=$pathModulo?>ajax.listarusuariosiugu.php?get",
	        dom: 'Bfrtip',
	        stateSave: true,
	        buttons: [
		        {
		        ...
		        switch (key) {
                    ...
                    case 'assinatura':
                        ...
                        confirmAction("Cancelar Assinatura", "Você deseja realmente cancelar a assiantura do cliente selecionado?").then(function(){
				        	$.ajax({
								type: 'POST',
								url: '<?=$pathModulo?>ajax.listarusuariosiugu.php?get',
								dataType: 'JSON',
