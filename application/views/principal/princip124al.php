...
<section style="text-align:justify;" class="menor" >
		<div class="left " width="90%"   style="padding:20px;box-shadow: 5px 10px 20px black inset;background-image:url(<?PATH_ABSOLUTO?> <?if(!$styless){echo"application/views/principal/banner.jpg)";}else{echo"application/views/principal/banner.jpg)";} ?>;background-repeat: no-repeat, repeat;width:100%;background-size: 100% 100%;">
...
<section style="padding:0px;background-image: linear-gradient(180deg, #fd7e15 0%, #fc7100 100%);color:white"class="section-space " >
  ...
  <section id="blackpromo" class="section-space " >
    <h1 class="center text-center" style="color:#ea5312;padding-top:20px;width:65%"> ASSINE O PLANO ENTENDEU E RECEBA EM CASA COM EXCLUSIVIDADE NOSSO LIVRO SOBRE DIREITO ADMINISTRATIVO E CONSTITUCIONAL
</h1>
